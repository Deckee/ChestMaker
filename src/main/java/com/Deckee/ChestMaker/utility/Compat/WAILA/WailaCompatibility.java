package com.Deckee.ChestMaker.utility.Compat.WAILA;
...
public class WailaCompatibility implements IWailaDataProvider {
    ...
    public static void load(IWailaRegistrar registrar)
    {
        ...
        if (!loaded)
        {
            registrar.registerHeadProvider(INSTANCE, Chestmaker.class);

            registrar.registerBodyProvider(INSTANCE, Chestmaker.class);

            registrar.registerTailProvider(INSTANCE, Chestmaker.class);
            loaded = true;
        }
    }
    ...
    public static void register() {
        if (registered)
            return;
        registered = true;
        FMLInterModComms.sendMessage("Waila", "register", "com.Deckee.ChestMaker.utility.Compat.WAILA.WailaCompatibility.load");
    }
    @Override
